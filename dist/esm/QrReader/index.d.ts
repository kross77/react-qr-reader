...
import { OnErrorFunction, OnScanFunction, OnLoadFunction, DebugFunction } from './hooks/useQrReader';
...
export declare const QrReader: React.FunctionComponent<QrReaderProps>;
